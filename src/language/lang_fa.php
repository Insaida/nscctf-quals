...
$translations = array(
  ...
  '+ Link' =>
    '+ لینک',
  'Flags Management' =>
    'مدیریت چالشهای پرچمی',
  'Add Flag Level' =>
    'اضافه کردن چالش پرچمی',
  'New Base Level' =>
    'چالش جدید پایگاهی',
  'Keep Points' =>
    'امتیاز حفظ',
  'Capture points' =>
    'امتیاز فتح',
  'All Base Levels' =>
    'همه ی چالش های پایگاهی',
  'Base Level' =>
    'چالش پایگاه',
  'Bases Management' =>
    'مدیریت پایگاه ها',
  'Add Base Level' =>
    'اضافه کردن چالش پایگاه',
  'New Category' =>
    'دسته جدید',
  'Category: ' =>
    'دسته: ',
  ...
  'Are you sure you want to kick off the game? Logs will be cleared and progressive scoreboard will start' =>
    'آیا مطئن هستید که می خواهید بازی را شروع کنید؟ همه لاگ ها حذف می شوند و اسکوربورد شروع به کار خواهد کرد',
  'end_' =>
    'پایان_',
